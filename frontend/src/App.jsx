...
import { ForgotPasswordPage, ResetPasswordPage, ResendVerificationPage } from "./pages/RecoveryPages";
import LoginPage from "./pages/LoginPage";
import RegisterPage from "./pages/RegisterPage";
import { NotFoundPage, UnauthorizedPage, VerifyEmailPage } from "./pages/StatusPages";
import ProtectedRoute, { PageLoader } from "./routes/ProtectedRoute";
import { useRouter } from "./routes/useRouter";
import "./App.css";

const publicPaths = ["/login", "/register", "/forgot-password", "/reset-password", "/resend-verification", "/verify-email"];
...
function App() {
  ...
  const publicPage = { "/login": <LoginPage navigate={navigate} search={search} />, "/register": <RegisterPage navigate={navigate} />, "/forgot-password": <ForgotPasswordPage navigate={navigate} />, "/reset-password": <ResetPasswordPage navigate={navigate} token={resetToken} />, "/resend-verification": <ResendVerificationPage navigate={navigate} />, "/verify-email": <VerifyEmailPage navigate={navigate} search={search} /> }[pathname];
